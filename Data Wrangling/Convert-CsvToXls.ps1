function Convert-CsvToXls {
    <#    
        ...
        .PARAMETER File
            The .csv file to be converted. Accepts pipeline.
    ...
    Param(
        [Parameter(Mandatory, Position = 0, ValueFromPipeline, ParameterSetName = 'fromstring')]
        [string]$Path,
        [Parameter(Mandatory, Position = 0, ValueFromPipeline, ParameterSetName = 'fromfile')]
